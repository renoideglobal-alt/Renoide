...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://renoide.in/renoide-logo.png" },
      ...
      { name: "twitter:image", content: "https://renoide.in/renoide-logo.png" },
    ],
    links: [
  ...
  "@graph": [
    {
      ...
      contactPoint: { "@type": "ContactPoint", email: "mail.renoide@gmail.com", contactType: "customer support" },
      member: [
